...
__all__ = [
    ...
    "matrixtransformer",
    "graph",
    "tgc",  # Graph Traversal Command module
]

def __getattr__(name):
    """Lazy-import a submodule on attribute access.

    Example: heavy submodules (like `matrixtransformer`) are imported lazily
    to avoid pulling in optional dependencies at import time.
    """
    if name in __all__:
        import importlib
