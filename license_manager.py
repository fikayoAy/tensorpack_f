...
# Cryptolens configuration (as provided by the user)
CRYPTOLENS_PRODUCT_ID = "Id30951"
CRYPTOLENS_API_TOKEN = "WyIxMTIyMDU1NDUiLCJNU0lJZWhjaWhrZHJkMEJ0Q3ZjU0plLzlhRGl6dXJLTTNKZXpFM3lCIl0="
# Minimal Cryptolens endpoint for license key verification (public REST)
# We'll use the Licenses/Key method: https://cryptolens.io/docs/api/#get-license
CRYPTOLENS_VERIFY_URL = "https://api.cryptolens.io/api/key/ActivateKey"
...
class LicenseManager:
    ...
    def _verify_with_cryptolens(self, license_key: str) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            params = {
                'ProductId': self.cryptolens_product,
                'Key': license_key,
            ...
            data = resp.json()
            # Cryptolens returns a structure with 'License' when valid
            if data.get('License'):
